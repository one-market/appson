...
const denormalizedDiff = (prev: DiffObj, current: DiffObj) =>
  R.differenceWith(R.eqProps('name'), denormalize(prev), denormalize(current))

const symmetricDenormalizedDiff = (prev: DiffObj, current: DiffObj) =>
